            ...
            <form wire:submit.click="{{ $isEditing ? "update($id)" : "store" }}">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input required wire:model="name" type="text" name="name"
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-primary btn-sm" wire:click="add">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button"
                                            wire:click="destroy({{ $subspeciality->id }})"
                                            class="btn btn-danger btn-sm"
                                            title="Delete"
                                            onclick="return confirm('Are you sure you want to delete this Sub Speciality?');">
