    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-end align-items-center mb-3 gap-2">
          {{-- Search form --}}
          <form action="{{ route('specialities.index') }}" method="GET" class="d-inline-block">
          ...
          <a href="{{ route('specialities.index') }}" title="Reset" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span class="badge bg-success">{{ $speciality->sub_specialities_count }}</span>
              </td>
...
@push('scripts')
<script>
  console.log('Specialities index page loaded');
